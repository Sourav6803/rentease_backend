  ...
  send(_regIds, data, callback) {
    ...
    regIds.forEach(regIdOriginal => {
      const {
        regId,
        pushMethod
      } = this.getPushMethodByRegId(regIdOriginal);
